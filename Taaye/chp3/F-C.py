...
print 'The formula is,', F , 'To find the answer I must divide the distance by the speed.'
print 'To find the answer I must divide the distance by the speed. Since the distance is,', D
print 'and the speed is,', SP
